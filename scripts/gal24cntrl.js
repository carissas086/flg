...
function setControlIds(target) {
    ...
    // ==== STOP AT MIN GALLERY ITEMS
        ...
        if (setId == '68') {
            cntlPrev.setAttribute('data-id','flg68');
            cntlNext.setAttribute('data-id','flg69');
            return;
        } else {
    ...
    // ==== CARVE OUT for 77
        ...
        if (setId == '76') {
            cntlPrev.setAttribute('data-id','flg' + '75');
            cntlNext.setAttribute('data-id','flg' + '78');
            exSetGal('easter24');
            return;
        } else {
            cntlPrev.setAttribute('data-id','flg' + setPrev.toString());
        ...
        if (setId == '78') {
            cntlPrev.setAttribute('data-id','flg' + '76');
            cntlNext.setAttribute('data-id','flg' + '79');
    ...
    // ==== SET MAX GALLERY ITEMS
        ...
        if(setId == '84') {
            cntlPrev.setAttribute('data-id','flg' + setPrev.toString());
            cntlNext.setAttribute('data-id','flg' + '84');
        } else {
