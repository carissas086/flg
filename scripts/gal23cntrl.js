...
function setControlIds(target) {
    ...
    // ==== STOP AT MIN GALLERY ITEMS
        ...
        if (setId == '24') {
            cntlPrev.setAttribute('data-id','flg24');
            cntlNext.setAttribute('data-id','flg25');
            return;
        } else {
    ...
    // ==== CARVE OUT for 77
        ...
        if (setId == '51') {
            cntlPrev.setAttribute('data-id','flg' + '50');
            cntlNext.setAttribute('data-id','flg' + '77');
            exSetGal('fall23');
            return;
        } else {
            cntlPrev.setAttribute('data-id','flg' + setPrev.toString());
        ...
        if (setId == '77') {
            cntlPrev.setAttribute('data-id','flg' + '51');
            cntlNext.setAttribute('data-id','flg' + '52');
            exSetGal('fall23');
            return;
        } else {
            cntlPrev.setAttribute('data-id','flg' + setPrev.toString());
        ...
        if (setId == '52') {
            cntlPrev.setAttribute('data-id','flg' + '77');
            cntlNext.setAttribute('data-id','flg' + '53');
    ...
    // ==== SET MAX GALLERY ITEMS
        ...
        if(setId == '67') {
            cntlPrev.setAttribute('data-id','flg' + setPrev.toString());
            cntlNext.setAttribute('data-id','flg' + '67');
        } else {
