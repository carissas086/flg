...
<html lang="en-CA">
    <head>
        ...
        <!-- horizontal gallery sequence at top
        flc logo on top -->
        ...
        <!-- ==== Gallery Specific Styles ==== -->
            <link rel="stylesheet" href="styles/gallery-styles/christmas22.css">
                ...
                <section id="galleryhd">
                    <div class="gallery-wrap">
                        ...
                        <!-- ==== ISOTOPE/GALLERY GRID ==== -->
                            <!-- /galleries/TAG/TAG##.php -->
                            <section class="grid">

                                <?php include __DIR__ . '/galleries/christmas22/christmas2201.php'; ?>
                                <?php include __DIR__ . '/galleries/christmas22/christmas2202.php'; ?>
                                <?php include __DIR__ . '/galleries/christmas22/christmas2203.php'; ?>
                                <?php include __DIR__ . '/galleries/christmas22/christmas2204.php'; ?>
